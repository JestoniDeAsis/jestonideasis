namespace VitalHealth.Forms.Doctor
{
    partial class DoctorViewPastRecords
    {
        ...
        private void InitializeComponent()
        {
            ...
            label11 = new Label();
            txtB_symptomsReport = new RoundedTextBox();
            label10 = new Label();
            label9 = new Label();
            label8 = new Label();
            label7 = new Label();
            ...
            // txtB_symptomsReport
            // 
            txtB_symptomsReport.BackColor = Color.Transparent;
            txtB_symptomsReport.Font = new Font("Poppins", 12F, FontStyle.Regular, GraphicsUnit.Point, 0);
            txtB_symptomsReport.Location = new Point(37, 375);
            txtB_symptomsReport.Name = "txtB_symptomsReport";
            txtB_symptomsReport.Size = new Size(710, 125);
            txtB_symptomsReport.TabIndex = 64;
            txtB_symptomsReport.Theme = ControlTheme.Light;
            // 
            // label10
            // 
        ...
        private RoundedTextBox txtB_symptomsReport;
