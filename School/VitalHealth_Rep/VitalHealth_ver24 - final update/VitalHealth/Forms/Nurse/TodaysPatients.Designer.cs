...
namespace VitalHealth.Forms.Nurse
{
    partial class TodaysPatients
    {
        ...
        private void InitializeComponent()
        {
            ...
            page4DG = new Label();
            page3DG = new Label();
            cmbB_filterStatus = new RoundedComboBox();
            cmbB_filterDay = new RoundedComboBox();
            ...
            // cmbB_filterStatus
            // 
            cmbB_filterStatus.BackColor = Color.White;
            cmbB_filterStatus.DrawMode = DrawMode.OwnerDrawFixed;
            cmbB_filterStatus.DropDownStyle = ComboBoxStyle.DropDownList;
            cmbB_filterStatus.Font = new Font("Poppins", 15.75F, FontStyle.Regular, GraphicsUnit.Point, 0);
            cmbB_filterStatus.ForeColor = Color.Black;
            cmbB_filterStatus.FormattingEnabled = true;
            cmbB_filterStatus.IntegralHeight = false;
            cmbB_filterStatus.Items.AddRange(new object[] { "All", "Waiting", "On-going", "To Pay", "Done", "On-hold" });
            cmbB_filterStatus.Location = new Point(1217, 123);
            cmbB_filterStatus.Name = "cmbB_filterStatus";
            cmbB_filterStatus.PlaceholderText = "Filter by Status";
            cmbB_filterStatus.Size = new Size(316, 40);
            cmbB_filterStatus.TabIndex = 33;
            cmbB_filterStatus.Theme = ControlTheme.Light;
            cmbB_filterStatus.SelectedIndexChanged += cmbB_filterStatus_SelectedIndexChanged;
            // 
            // cmbB_filterDay
            // 
            cmbB_filterDay.BackColor = Color.White;
            cmbB_filterDay.DrawMode = DrawMode.OwnerDrawFixed;
            cmbB_filterDay.DropDownStyle = ComboBoxStyle.DropDownList;
            cmbB_filterDay.Font = new Font("Poppins", 15.75F, FontStyle.Regular, GraphicsUnit.Point, 0);
            cmbB_filterDay.ForeColor = Color.Black;
            cmbB_filterDay.FormattingEnabled = true;
            cmbB_filterDay.IntegralHeight = false;
            cmbB_filterDay.Items.AddRange(new object[] { "Today", "Past" });
            cmbB_filterDay.Location = new Point(1704, 169);
            cmbB_filterDay.Name = "cmbB_filterDay";
            cmbB_filterDay.PlaceholderText = "Filter day";
            cmbB_filterDay.Size = new Size(169, 40);
            cmbB_filterDay.TabIndex = 34;
            cmbB_filterDay.Theme = ControlTheme.Light;
            cmbB_filterDay.Visible = false;
            cmbB_filterDay.SelectedIndexChanged += cmbB_filterDay_SelectedIndexChanged;
            // 
            // TodaysPatients
            // 
            ...
            Controls.Add(cmbB_filterDay);
            Controls.Add(cmbB_filterStatus);
        ...
        private RoundedComboBox cmbB_filterStatus;
        private RoundedComboBox cmbB_filterDay;
    }
}